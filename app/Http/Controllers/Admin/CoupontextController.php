...
class CoupontextController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        if(request()->ajax())
        {
            return datatables()->of(Coupontext::latest())
    ...
    public function update(Request $request)
    {
        ...
        Coupontext::whereId($request->hidden_id)->update($form_data);
