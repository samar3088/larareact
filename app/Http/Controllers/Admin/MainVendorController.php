...
class MainVendorController extends Controller
{
    ...
    public function index()
    {
        ...
        if(request()->ajax())
        {
            return datatables()->of(Mainvendor::latest())
    ...
    public function update(Request $request)
    {
        ...
        Mainvendor::whereId($request->hidden_id)->update($form_data);
