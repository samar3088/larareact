...
@section('pageheading','Home Page Sliders')
@section('cardheading','Add Home Page Sliders')
                ...
                <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="heading" id="heading" cols="30" rows="2"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="buttonlink" id="buttonlink" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label>Enter Sub Text</label>
                            <input type="text" name="subtext" id="subtext" class="form-control"/>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    $(document).ready(function() {
        $('#user_table').DataTable({
            ...
            "order": [[ 0, "desc" ]],
            ajax:{
                url: "{{ route('admin.homeslider.index') }}",
            },
            columns:
            [
                {
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == "Update")
            {
                $.ajax
                ({
                    url:"{{ route('admin.homeslider.update') }}",
                    method:"POST",
                    data:new FormData(this),
                    contentType: false,
                    cache: false,
        ...
        $(document).on('click', '.edit', function(){
            ...
            ({
                ...
                success:function(html)
                {
                    ...
                    $('#buttontext').val(html.data.buttontext);
                    $('#buttonlink').val(html.data.buttonlink);
                    $('#subtext').val(html.data.subtext);
        ...
        $(document).on('click', '.delete', function(){
            ...
            {
                $.ajax({
                    url:"/admin/homeslider/destroy/"+id,
                    mehtod:"get",
                    data:{id:id},
                    success:function(data)
                    {
