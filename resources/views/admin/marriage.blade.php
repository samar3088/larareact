...
@section('pageheading','Marriage Sub Themes')
@section('cardheading','Add Marriage Sub Themes')
...
<script>
    ...
    $(document).ready(function() {
        $('#user_table').DataTable({
            ...
            "order": [[ 0, "desc" ]],
            ajax:{
                url: "{{ route('admin.marriagesubthemes.index') }}",
            },
            columns:
            [
                {
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == 'Add')
            {
                $.ajax
                ({
                    url:"{{ route('admin.marriagesubthemes.store') }}",
                    method:"POST",
            ...
            if($('#action').val() == "Update")
            {
                $.ajax
                ({
                    url:"{{ route('admin.marriagesubthemes.update') }}",
                    method:"POST",
                    data:new FormData(this),
                    contentType: false,
                    cache: false,
        ...
        $(document).on('click', '.edit', function(){
            ...
            ({
                ...
                url:"/admin/marriagesubthemes/"+id+"/edit",
                dataType:"json",
        ...
        $(document).on('click', '.delete', function(){
            ...
            {
                $.ajax({
                    url:"/admin/marriagesubthemes/destroy/"+id,
                    mehtod:"get",
                    data:{id:id},
                    success:function(data)
                    {
        ...
        $(document).on('click', '.remove_subimages', function(){
            ...
            {
                $.ajax({
                    url:"/admin/marriagesubthemes/delsubimage/"+id,
                    mehtod:"get",
                    data:{id:id},
                    success:function(data)
                    {
