...
<div class="wrapper">
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="rightbox">
                    <div class="profile">
                        <div class="personaltext">
                            <form method="post" id="single_checkout_form" class="" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-center btnstop">
                        ...
                        <div class="otptext" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-2 text-center"></div>
                                <div class="col-md-6 text-center btnquote">
                                    ...
                                    {{-- @if ($booking_type == 'cart_single')
                                        <button id="btnSendquote" class="btn btn-primary btnSendquote" value="Proceed to Checkout" name="btnSendquote" style="margin-bottom: 1em;">Get Quotation</button>
                                    @elseif ($booking_type == 'cart_wedding')
                                        <button id="btnSendquoteCartWedding" class="btn btn-primary btnSendquote" value="Proceed to Checkout" name="btnSendquoteCartWedding" style="margin-bottom: 1em;">Get Quotation</button>
                                    @else
                                        <button id="btnSendquoteCartGeneral" class="btn btn-primary btnSendquote" value="Proceed to Checkout" name="btnSendquoteCartGeneral" style="margin-bottom: 1em;">Get Quotation</button>
                                    @endif --}}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4 errorshowingresult">
            ...
            <!-- ends form -->
            <!-- starts quotation -->
                <div class="row quotationappear" style="display: none;">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
           <div class="modal-content">
              ...
              <div class="modal-body">
                 ...
                 <p>Tosshead Events India Pvt Ltd ("Tosshead"), primarily operates controls and manages the Services (as defined below) provided by it from its corporate office at Bangalore.
                 </p>
                 ...
                 <p>All references to "you" or "your," as applicable, mean the person that accesses, uses, and/or participates in the Website in any manner. If you use the Website (as defined below) on behalf of a business, you represent and warrant that you have the authority to bind that business and your acceptance of the Terms of Use will be deemed an acceptance by that business and "you" and "your" herein shall refer to that business.
                 </p>
