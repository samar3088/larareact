...
<div class="mt-125">
    <div class="m-hide row full-width" id="venuebanner" align="center">
       <div class="col-md-2">
       </div>
       ...
       <div class="directory-structure clearfix">
          <div id="app-vendors-directory-result-list" class="directory-structure-content">
             <div class="right-panel-search">
                <div class="col-lg-10 col-md-10 col-sm-12" style="margin-bottom: 400px;">
                   <div id="right_searchresult">
                      ...
                      <div class="found-status" style="margin-bottom:25px;font-size: 12px">
                         <div id="cityDIVS2">
                            <div class="collapseWrapper22" style="height: 92px;">
                               <p class="collapse22">
                                 {{ $page_items->content }}
                               </p>
                               <p>{!! $page_items->additional_line !!}</p>
                            </div>
                         </div>
                      </div>
                       <!-- for search -->  
                ...
                <div class="left-panel datareprs">
                   ...
                   <div class="panel-group expand-fd" id="accordion" style="margin-top: 12px;">
                      <div class="panel panel-default ">
                         <div class="panel-heading panel-head-1">
                            <h4 class="panel-title panel_item">
                               <a role="button"  aria-expanded="true" aria-controls="">Theme Name</a>
                            </h4>
                         </div>
                         <div class="panel-heading panel-head-2">
                            <input id="item_venue_types" class="searchinput" type="text" placeholder="Search By Venue Type">
                         </div>
                         <div id="style-3" class="panel-collapse collapse in default_height scrollbar" style="display:block; height: 180px;">
                            <div id="" class="panel-body ">
                               <ul class="venueTypes item_venue_types" id="listvals">
                      ...
                      <div class="panel panel-default ">
                         <div class="panel-heading panel-head-1">
                            <h4 class="panel-title panel_item">
                               <a role="button" data-toggle="collapse" data-parent="#accordion" href="" aria-expanded="true" aria-controls="collapseTeo">Price Range</a>
                            </h4>
                         </div>
                         <div id="style-3" class="panel-collapse collapse in default_height scrollbar" style="display:block;margin-top: 5px;">
                            <div id="" class="panel-body ">
                               <ul class="venueTypes item_venue_type ">
                                  <li class="facet__item">
                                     <input style="display: none;" rel="nofollow" href="" class="leftchkliLoc2 common-sprite check" id="bday_price_filter1" type="checkbox" name="checkbox" value="1">
                                     <label style="margin-left: 0px!important" class=""  for="bday_price_filter1">500-3500</label>
                                  </li>
                                  <li class="facet__item">
                                     <input style="display: none;" rel="nofollow" onclick="" class="leftchkliLoc2 common-sprite check" id="bday_price_filter2" type="checkbox" name="checkbox" value="2">
                                     <label style="margin-left: 0px!important" class="" onclick="" for="bday_price_filter2">3500-5000</label>
                                  </li>
                                  <li class="facet__item">
                                     <input style="display: none;" rel="nofollow" onclick="" class="leftchkliLoc2 common-sprite check" id="bday_price_filter3" type="checkbox" name="checkbox" value="3">
                                     <label style="margin-left: 0px!important" class="" onclick="" for="bday_price_filter3">5000-10000</label>
                                  </li>
                                  <li class="facet__item">
                                     <input style="display: none;" rel="nofollow" onclick="" href="" class="leftchkliLoc2 common-sprite check" id="bday_price_filter4" type="checkbox" name="checkbox" value="4">
                                     <label style="margin-left: 0px!important" class="" onclick="" for="bday_price_filter4">Above 10000</label>
                                  </li>
                               </ul>
                            </div>
                         </div>
...
@push('js')
        ...
        <script>
         $(document).ready(function() {
            ...
            //$('.panel-body ul.item_venue_types li:first .leftchkliLoc1').prop("checked", true);
         ...
         $(document).on('change', "input[class^='leftchkliLoc2']", function()
         {   
            $("#employee-grid").dataTable().fnDestroy();
            //dataTable.search(searchterm).draw();
            loadTables();
         ...
         function loadTables() 
         {
            ...
            $('.leftchkliLoc2:checked').each(function(){
            ...
            dataTable = $('#employee-grid').DataTable({
                  ...
                  "ajax":
                  {
                     url: "{{ route('website.birthdays') }}",
                     "data": function ( d ) 
                     {
                           d.filter_id = filter_id;
                           d.filter_price = filter_price;
                           d.cityid = cityid;
