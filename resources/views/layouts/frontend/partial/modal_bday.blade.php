            ...
            <div class="modal-body">
                <div class="contact1">
                    ...
                    <div class="container-contact1">
                        ...
                        <form method="post" id="bday_footer_modal" class="contact1-form validate-form" enctype="multipart/form-data">
                            ...
                            <div class="wrap-input1 validate-input" data-validate = "Image is required">
                                <input class="input1" type="file" name="bday_image" id="bday_image" required="" style="padding-top: 10px;">
                                <span class="shadow-input1"></span>
                            </div>
                            ...
                            <div class="container-contact1-form-btn">
                                <button id="bday_footer_modal_btn" class="contact1-form-btn"><span>Send Email<i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></button>
                            </div>
                        </form>
                    </div>
                </div>
